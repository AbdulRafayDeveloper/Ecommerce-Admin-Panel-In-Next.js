...
function Page() {
    ...
    const [filteredHotelTypes, setfilteredHotelTypes] = useState([]); // Initialize with an empty array
            ...
            await axios.get(`http://localhost:5000/api/hotelTypes`)
                .then((result) => {
                    ...
                    if (Array.isArray(result.data)) {
                        ...
                        setfilteredHotelTypes(result.data);
                    } else {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.delete(`http://localhost:5000/api/hotelTypes/${id}`);
        ...
        <div className="flex flex-col md:flex-row h-screen">
            ...
            <div className="flex-1 overflow-auto bg-gray-100">
                ...
                <div className='p-4 bg-white mx-5 mt-3 rounded-lg shadow-lg'>
                    <div>
                        <h2 className="text-2xl font-medium mb-3 text-black">Hotel Types List</h2>
                        <div className='flex justify-between items-center mb-4'>
                            <div className='flex'>
                                <Link href="../../../admin/hotelTypes/add" className='text-sm w-28 h-8 flex items-center justify-center border border-blue-600 bg-white mr-3 rounded-xl transition duration-300 ease-in-out transform hover:scale-105 shadow-sm' passHref>
                            ...
                            <table className="w-full bg-white rounded-lg shadow-lg overflow-hidden">
                                <thead className="bg-blue-400">
                                    <tr>
                                        ...
                                        <th className="p-2 border border-gray-300 text-white" style={{ width: "40%" }}>Thumb</th>
                                        ...
                                        displayedEmployee.map((element, index) => (
                                            <tr className="hover:bg-gray-100">
                                                ...
                                                <td className="text-center border border-gray-300 p-1 text-gray-900">
                                                    <Image src={`${element.thumb}`} alt="employee pic" width={50} height={50} className='mx-auto' />
                                                </td>
